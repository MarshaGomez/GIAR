...
//	
//	public static void evaluateBayes(Instances test) {
//		
//		//evaluation for each training and test set in vettTrain and vettTest
//		 //
//		 for (int i=0; i < 12; i++){
...
//			 
//			 NaiveBayes classif = new NaiveBayes();
//			// building a classifier for each training set in vettTrain
//			 classif.buildClassifier(vettTrain[i]);
//			//evaluation for each training and test set in vettTrain and vettTest
//			 Evaluation evalTr = new Evaluation(vettTrain[i]);
//			 Evaluation evalTs = new Evaluation(vettTest[i]);
//			 evalTr. evaluateModel(classif, vettTrain[i]);
//			 evalTs.evaluateModel(classif, vettTest[i]);
//			 //Extracting errors and calculating the lowest error
...
//	}
//	
//	public static void evaluateSMO() {
//		
//		//evaluation for each training and test set in vettTrain and vettTest
//		 //
//		 for (int i=0; i < 4; i++){
...
//	}
//	
//	public static void evaluateRandomForest() {
//		
//		//evaluation for each training and test set in vettTrain and vettTest
//		 //
//		 for (int i=0; i < 4; i++){
